...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "r", function() { return AbortedDeferredError; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return Action; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return ErrorResponse; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "p", function() { return IDLE_BLOCKER; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "j", function() { return getPathContributingMatches; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return createMemoryHistory; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "h", function() { return createPath; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return createRouter; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "g", function() { return joinPaths; });
/* unused harmony export json */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return matchPath; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return matchRoutes; });
/* unused harmony export normalizePathname */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return parsePath; });
/* unused harmony export redirect */
/* unused harmony export redirectDocument */
/* unused harmony export resolvePath */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "k", function() { return resolveTo; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__remix_run_router__ = __webpack_require__(1);
/**
...
function getFormSubmissionInfo(target, basename) {
  ...
  if (isFormElement(target)) {
    ...
    action = attr ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["a" /* stripBasename */])(attr, basename) : null;
...
function createBrowserRouter(routes, opts) {
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["b" /* createRouter */])({
    basename: opts == null ? void 0 : opts.basename,
    future: _extends({}, opts == null ? void 0 : opts.future, {
      v7_prependBasename: true
    }),
    history: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["c" /* createBrowserHistory */])({
      window: opts == null ? void 0 : opts.window
    }),
    hydrationData: (opts == null ? void 0 : opts.hydrationData) || parseHydrationData(),
    routes,
    mapRouteProperties: __WEBPACK_IMPORTED_MODULE_1_react_router__["c" /* UNSAFE_mapRouteProperties */]
  }).initialize();
}
function createHashRouter(routes, opts) {
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["b" /* createRouter */])({
    ...
    history: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["d" /* createHashHistory */])({
      window: opts == null ? void 0 : opts.window
    }),
    hydrationData: (opts == null ? void 0 : opts.hydrationData) || parseHydrationData(),
    routes,
...
function deserializeErrors(errors) {
  ...
  for (let [key, val] of entries) {
    ...
    if (val && val.__type === "RouteErrorResponse") {
      serialized[key] = new __WEBPACK_IMPORTED_MODULE_2__remix_run_router__["e" /* ErrorResponse */](val.status, val.statusText, val.data, val.internal === true);
...
function BrowserRouter(_ref) {
  ...
  if (historyRef.current == null) {
    historyRef.current = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["c" /* createBrowserHistory */])({
      window,
      v5Compat: true
    });
  }
...
function HashRouter(_ref2) {
  ...
  let historyRef = __WEBPACK_IMPORTED_MODULE_0_react__["useRef"]();
  if (historyRef.current == null) {
    historyRef.current = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["d" /* createHashHistory */])({
      window,
      v5Compat: true
    });
  }
...
const Link = /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react__["forwardRef"](function LinkWithRef(_ref4, ref) {
  ...
  let {
    basename
  } = __WEBPACK_IMPORTED_MODULE_0_react__["useContext"](__WEBPACK_IMPORTED_MODULE_1_react_router__["e" /* UNSAFE_NavigationContext */]);
  ...
  if (typeof to === "string" && ABSOLUTE_URL_REGEX.test(to)) {
    ...
    if (isBrowser) {
      try {
        ...
        let path = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["a" /* stripBasename */])(targetUrl.pathname, basename);
  ...
  let href = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_router__["f" /* useHref */])(to, {
    relative
  });
...
const NavLink = /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react__["forwardRef"](function NavLinkWithRef(_ref5, ref) {
  ...
  let path = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_router__["g" /* useResolvedPath */])(to, {
    relative: rest.relative
  });
  let location = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_router__["h" /* useLocation */])();
  let routerState = __WEBPACK_IMPORTED_MODULE_0_react__["useContext"](__WEBPACK_IMPORTED_MODULE_1_react_router__["i" /* UNSAFE_DataRouterStateContext */]);
  let {
    navigator
  } = __WEBPACK_IMPORTED_MODULE_0_react__["useContext"](__WEBPACK_IMPORTED_MODULE_1_react_router__["e" /* UNSAFE_NavigationContext */]);
...
function useDataRouterContext(hookName) {
  ...
  !ctx ?  false ? UNSAFE_invariant(false, getDataRouterConsoleError(hookName)) : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  return ctx;
}
function useDataRouterState(hookName) {
  let state = __WEBPACK_IMPORTED_MODULE_0_react__["useContext"](__WEBPACK_IMPORTED_MODULE_1_react_router__["i" /* UNSAFE_DataRouterStateContext */]);
  !state ?  false ? UNSAFE_invariant(false, getDataRouterConsoleError(hookName)) : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  return state;
}
/**
...
function useSubmit() {
  ...
  let currentRouteId = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_router__["m" /* UNSAFE_useRouteId */])();
...
function useSubmitFetcher(fetcherKey, fetcherRouteId) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react__["useCallback"](function (target, options) {
    ...
    !(fetcherRouteId != null) ?  false ? UNSAFE_invariant(false, "No routeId available for useFetcher()") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
...
function useFormAction(action, _temp2) {
  ...
  let routeContext = __WEBPACK_IMPORTED_MODULE_0_react__["useContext"](__WEBPACK_IMPORTED_MODULE_1_react_router__["n" /* UNSAFE_RouteContext */]);
  !routeContext ?  false ? UNSAFE_invariant(false, "useFormAction must be used inside a RouteContext") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  let [match] = routeContext.matches.slice(-1);
  // Shallow clone path so we can modify it below, otherwise we modify the
  // object referenced by useMemo inside useResolvedPath
  let path = _extends({}, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_router__["g" /* useResolvedPath */])(action ? action : ".", {
    relative
  }));
  ...
  if (basename !== "/") {
    path.pathname = path.pathname === "/" ? basename : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["g" /* joinPaths */])([basename, path.pathname]);
  }
...
function useFetcher() {
  ...
  let route = __WEBPACK_IMPORTED_MODULE_0_react__["useContext"](__WEBPACK_IMPORTED_MODULE_1_react_router__["n" /* UNSAFE_RouteContext */]);
  !route ?  false ? UNSAFE_invariant(false, "useFetcher must be used inside a RouteContext") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  let routeId = (_route$matches = route.matches[route.matches.length - 1]) == null ? void 0 : _route$matches.route.id;
  !(routeId != null) ?  false ? UNSAFE_invariant(false, "useFetcher can only be used on routes that contain a unique \"id\"") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  ...
  let [Form] = __WEBPACK_IMPORTED_MODULE_0_react__["useState"](() => {
    !routeId ?  false ? UNSAFE_invariant(false, "No routeId available for fetcher.Form()") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
    return createFetcherForm(fetcherKey, routeId);
  });
  let [load] = __WEBPACK_IMPORTED_MODULE_0_react__["useState"](() => href => {
    !router ?  false ? UNSAFE_invariant(false, "No router available for fetcher.load()") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
    !routeId ?  false ? UNSAFE_invariant(false, "No routeId available for fetcher.load()") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
...
function useScrollRestoration(_temp3) {
  ...
  let location = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_router__["h" /* useLocation */])();
  let matches = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_router__["o" /* useMatches */])();
  let navigation = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_router__["p" /* useNavigation */])();
  ...
  if (typeof document !== "undefined") {
    ...
    __WEBPACK_IMPORTED_MODULE_0_react__["useLayoutEffect"](() => {
      ...
      _extends({}, location, {
        pathname: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2__remix_run_router__["a" /* stripBasename */])(location.pathname, basename) || location.pathname
      }), matches) : getKey;
...
function usePrompt(_ref8) {
  ...
  let blocker = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1_react_router__["q" /* unstable_useBlocker */])(when);
  __WEBPACK_IMPORTED_MODULE_0_react__["useEffect"](() => {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "i", function() { return DataRouterStateContext; });
/* unused harmony export UNSAFE_LocationContext */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return NavigationContext; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "n", function() { return RouteContext; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return mapRouteProperties; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "m", function() { return useRouteId; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "q", function() { return useBlocker; });
/* unused harmony export useActionData */
/* unused harmony export useAsyncError */
/* unused harmony export useAsyncValue */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return useHref; });
...
/* unused harmony reexport AbortedDeferredError */
/* unused harmony reexport NavigationType */
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "l", function() { return __WEBPACK_IMPORTED_MODULE_1__remix_run_router__["h"]; });
/* unused harmony reexport defer */
/* unused harmony reexport generatePath */
/* unused harmony reexport isRouteErrorResponse */
/* unused harmony reexport json */
...
function useHref(to, _temp) {
  ...
  "useHref() may be used only in the context of a <Router> component.") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  let {
    basename,
    navigator
  ...
  if (basename !== "/") {
    joinedPathname = pathname === "/" ? basename : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["g" /* joinPaths */])([basename, pathname]);
  }
...
function useLocation() {
  !useInRouterContext() ?  false ? UNSAFE_invariant(false, // TODO: This error is probably because they somehow have 2 versions of the
  // router loaded. We can help them understand how to avoid that.
  "useLocation() may be used only in the context of a <Router> component.") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
...
function useMatch(pattern) {
  !useInRouterContext() ?  false ? UNSAFE_invariant(false, // TODO: This error is probably because they somehow have 2 versions of the
  // router loaded. We can help them understand how to avoid that.
  "useMatch() may be used only in the context of a <Router> component.") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  let {
    pathname
  } = useLocation();
  return __WEBPACK_IMPORTED_MODULE_0_react__["useMemo"](() => __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["i" /* matchPath */])(pattern, pathname), [pathname, pattern]);
}
...
function useNavigateUnstable() {
  !useInRouterContext() ?  false ? UNSAFE_invariant(false, // TODO: This error is probably because they somehow have 2 versions of the
  // router loaded. We can help them understand how to avoid that.
  "useNavigate() may be used only in the context of a <Router> component.") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  ...
  let routePathnamesJson = JSON.stringify(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["j" /* UNSAFE_getPathContributingMatches */])(matches).map(match => match.pathnameBase));
  ...
  let navigate = __WEBPACK_IMPORTED_MODULE_0_react__["useCallback"](function (to, options) {
    ...
    let path = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["k" /* resolveTo */])(to, JSON.parse(routePathnamesJson), locationPathname, options.relative === "path");
    ...
    if (dataRouterContext == null && basename !== "/") {
      path.pathname = path.pathname === "/" ? basename : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["g" /* joinPaths */])([basename, path.pathname]);
    }
...
function useResolvedPath(to, _temp2) {
  ...
  let routePathnamesJson = JSON.stringify(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["j" /* UNSAFE_getPathContributingMatches */])(matches).map(match => match.pathnameBase));
  return __WEBPACK_IMPORTED_MODULE_0_react__["useMemo"](() => __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["k" /* resolveTo */])(to, JSON.parse(routePathnamesJson), locationPathname, relative === "path"), [to, routePathnamesJson, locationPathname, relative]);
}
...
function useRoutesImpl(routes, locationArg, dataRouterState) {
  !useInRouterContext() ?  false ? UNSAFE_invariant(false, // TODO: This error is probably because they somehow have 2 versions of the
  // router loaded. We can help them understand how to avoid that.
  "useRoutes() may be used only in the context of a <Router> component.") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  let {
    navigator
  } = __WEBPACK_IMPORTED_MODULE_0_react__["useContext"](NavigationContext);
  let {
  ...
  let matches = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["m" /* matchRoutes */])(routes, {
  ...
  let renderedMatches = _renderMatches(matches && matches.map(match => Object.assign({}, match, {
    ...
    pathname: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["g" /* joinPaths */])([parentPathnameBase,
    // Re-encode pathnames that were decoded inside matchRoutes
    navigator.encodeLocation ? navigator.encodeLocation(match.pathname).pathname : match.pathname]),
    pathnameBase: match.pathnameBase === "/" ? parentPathnameBase : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["g" /* joinPaths */])([parentPathnameBase,
    // Re-encode pathnames that were decoded inside matchRoutes
  ...
  if (locationArg && renderedMatches) {
    return /*#__PURE__*/__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](LocationContext.Provider, {
      value: {
        ...
        navigationType: __WEBPACK_IMPORTED_MODULE_1__remix_run_router__["n" /* Action */].Pop
      }
    }, renderedMatches);
  }
...
function DefaultErrorComponent() {
  ...
  let message = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["o" /* isRouteErrorResponse */])(error) ? error.status + " " + error.statusText : error instanceof Error ? error.message : JSON.stringify(error);
...
function _renderMatches(matches, parentMatches, dataRouterState) {
  ...
  if (errors != null) {
    ...
    !(errorIndex >= 0) ?  false ? UNSAFE_invariant(false, "Could not find a matching route for errors on route IDs: " + Object.keys(errors).join(",")) : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
...
function useDataRouterContext(hookName) {
  ...
  !ctx ?  false ? UNSAFE_invariant(false, getDataRouterConsoleError(hookName)) : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  return ctx;
}
function useDataRouterState(hookName) {
  let state = __WEBPACK_IMPORTED_MODULE_0_react__["useContext"](DataRouterStateContext);
  !state ?  false ? UNSAFE_invariant(false, getDataRouterConsoleError(hookName)) : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  return state;
}
function useRouteContext(hookName) {
  let route = __WEBPACK_IMPORTED_MODULE_0_react__["useContext"](RouteContext);
  !route ?  false ? UNSAFE_invariant(false, getDataRouterConsoleError(hookName)) : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  return route;
}
...
function useCurrentRouteId(hookName) {
  ...
  !thisRoute.route.id ?  false ? UNSAFE_invariant(false, hookName + " can only be used on routes that contain a unique \"id\"") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
...
function useActionData() {
  ...
  let route = __WEBPACK_IMPORTED_MODULE_0_react__["useContext"](RouteContext);
  !route ?  false ? UNSAFE_invariant(false, "useActionData must be used inside a RouteContext") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
...
function useBlocker(shouldBlock) {
  ...
  let blockerFunction = __WEBPACK_IMPORTED_MODULE_0_react__["useCallback"](arg => {
    ...
    return shouldBlock({
      currentLocation: _extends({}, currentLocation, {
        pathname: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["a" /* stripBasename */])(currentLocation.pathname, basename) || currentLocation.pathname
      }),
      nextLocation: _extends({}, nextLocation, {
        pathname: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["a" /* stripBasename */])(nextLocation.pathname, basename) || nextLocation.pathname
      }),
      historyAction
    });
  ...
  return blockerKey && state.blockers.has(blockerKey) ? state.blockers.get(blockerKey) : __WEBPACK_IMPORTED_MODULE_1__remix_run_router__["p" /* IDLE_BLOCKER */];
}
...
function MemoryRouter(_ref3) {
  ...
  let historyRef = __WEBPACK_IMPORTED_MODULE_0_react__["useRef"]();
  if (historyRef.current == null) {
    historyRef.current = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["q" /* createMemoryHistory */])({
      initialEntries,
      initialIndex,
      v5Compat: true
    });
...
function Navigate(_ref4) {
  ...
  "<Navigate> may be used only in the context of a <Router> component.") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  ...
  let path = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["k" /* resolveTo */])(to, __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["j" /* UNSAFE_getPathContributingMatches */])(matches).map(match => match.pathnameBase), locationPathname, relative === "path");
...
function Route(_props) {
   false ? UNSAFE_invariant(false, "A <Route> is only ever to be used as the child of <Routes> element, " + "never rendered directly. Please wrap your <Route> in a <Routes>.") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) ;
}
/**
...
function Router(_ref5) {
  ...
  !!useInRouterContext() ?  false ? UNSAFE_invariant(false, "You cannot render a <Router> inside another <Router>." + " You should never have more than one in your app.") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
  ...
  if (typeof locationProp === "string") {
    locationProp = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["l" /* parsePath */])(locationProp);
  }
  let {
    pathname = "/",
    search = "",
  ...
  let locationContext = __WEBPACK_IMPORTED_MODULE_0_react__["useMemo"](() => {
    let trailingPathname = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["a" /* stripBasename */])(pathname, basename);
...
class AwaitErrorBoundary extends __WEBPACK_IMPORTED_MODULE_0_react__["Component"] {
  ...
  render() {
    ...
    if (status === AwaitRenderStatus.error && promise._error instanceof __WEBPACK_IMPORTED_MODULE_1__remix_run_router__["r" /* AbortedDeferredError */]) {
...
function createRoutesFromChildren(children, parentPath) {
  ...
  __WEBPACK_IMPORTED_MODULE_0_react__["Children"].forEach(children, (element, index) => {
    ...
    !(element.type === Route) ?  false ? UNSAFE_invariant(false, "[" + (typeof element.type === "string" ? element.type : element.type.name) + "] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
    !(!element.props.index || !element.props.children) ?  false ? UNSAFE_invariant(false, "An index route cannot have child routes.") : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["f" /* UNSAFE_invariant */])(false) : void 0;
    let route = {
...
function createMemoryRouter(routes, opts) {
  return __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["b" /* createRouter */])({
    basename: opts == null ? void 0 : opts.basename,
    future: _extends({}, opts == null ? void 0 : opts.future, {
      v7_prependBasename: true
    }),
    history: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__remix_run_router__["q" /* createMemoryHistory */])({
...
module.exports = __webpack_require__.p + "static/media/map-center-overflow.e390ae79.jpg";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react_dom_client__ = __webpack_require__(23);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__styles_css__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__App__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__component_UploadImage__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__component_Preview__ = __webpack_require__(15);
...
function App() {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      null,
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        __WEBPACK_IMPORTED_MODULE_3_react_router_dom__["b" /* Routes */],
        null,
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["c" /* Route */], { path: '/', element: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__component_UploadImage__["a" /* default */], null) }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["c" /* Route */], { path: '/preview', element: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__component_Preview__["a" /* default */], null) }),
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3_react_router_dom__["c" /* Route */], { path: '*', element: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'p',
            null,
            'Sorry, nothing here'
          ) })
...
var useDrag = function useDrag(_ref) {
  var ref = _ref.ref,
      ...
      calculateFor = _ref$calculateFor === undefined ? "topLeft" : _ref$calculateFor;
  ...
  var updateFinalPosition = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["useCallback"])(function (width, height, x, y) {
  ...
  var handleMouseDown = function handleMouseDown(evt) {
    ...
    var _ref$current = ref.current,
        offsetTop = _ref$current.offsetTop,
        offsetLeft = _ref$current.offsetLeft;
  ...
  var handleMouseMove = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["useCallback"])(function (evt) {
    var draggableElement = ref.current;
  ...
  var recalculate = function recalculate(width, height) {
    ...
    var _ref$current2 = ref.current,
        offsetTop = _ref$current2.offsetTop,
        offsetLeft = _ref$current2.offsetLeft;
    ...
    updateFinalPosition(width ? boundingWidth : width, height ? boundingHeight : height, offsetLeft, offsetTop);
  };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_useDrag__ = __webpack_require__(11);



function AddressLabel(_ref) {
  var item = _ref.item,
      editItem = _ref.editItem,
      deleteItem = _ref.deleteItem;

  var draggableRef = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["useRef"])(null);

  var _useDrag = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__common_useDrag__["a" /* useDrag */])({
    ref: draggableRef
  }),
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "dot" })
  );
}

/* harmony default export */ __webpack_exports__["a"] = (AddressLabel);
...
function ModalDetail(_ref) {
  var currentAddress = _ref.currentAddress,
      setCurrentAddress = _ref.setCurrentAddress,
      listData = _ref.listData,
      setIsShowModal = _ref.setIsShowModal,
      zoom = _ref.zoom,
      setZoom = _ref.setZoom,
      setImageStyle = _ref.setImageStyle,
      selectAddress = _ref.selectAddress,
      setIsDisplay = _ref.setIsDisplay;
  ...
  var handleGetIndex = function handleGetIndex(isNext) {
    var currentIndex = listData.findIndex(function (x) {
      return x.id === currentAddress.id;
    });
    if (isNext) {
  ...
  var handleCloseModal = function handleCloseModal(isClose) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div", { className: "img-content" })
      ),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
...
function ModalUpdateData(props) {
  var x = props.x,
      y = props.y,
      addressInfro = props.addressInfro,
      handleChange = props.handleChange,
      handleCloseModal = props.handleCloseModal,
      isEdit = props.isEdit,
      handleEdit = props.handleEdit,
      addToListData = props.addToListData;
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      isEdit ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "button",
        { onClick: handleEdit },
        "Edit Data"
      ) : __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "button",
        { onClick: addToListData },
        "Save Data"
      )
    )
  );
...
/* harmony default export */ __webpack_exports__["a"] = (ModalUpdateData);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__access_img_map_center_overflow_jpg__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__access_img_map_center_overflow_jpg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__access_img_map_center_overflow_jpg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ModalDetail__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_react_router_dom__ = __webpack_require__(2);
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }();
...
function Preview() {
  ...
  var _useState5 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["useState"])(1),
      _useState6 = _slicedToArray(_useState5, 2),
      zoom = _useState6[0],
  ...
  var _useState7 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["useState"])({}),
      ...
      imgStyle = _useState8[0],
      setImageStyle = _useState8[1];

  var _useState9 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["useState"])('block'),
      _useState10 = _slicedToArray(_useState9, 2),
      isDisplay = _useState10[0],
      setIsDisplay = _useState10[1];

  var listData = JSON.parse(localStorage.getItem('lists'));

  var selectAddress = function selectAddress(item) {
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", {
        src: __WEBPACK_IMPORTED_MODULE_1__access_img_map_center_overflow_jpg___default.a,
        alt: "abc",
        style: imgStyle
      }),
      listData && listData.length > 0 && listData.map(function (item) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    isShowModal && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__ModalDetail__["a" /* default */], {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__access_img_map_center_overflow_jpg__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__access_img_map_center_overflow_jpg___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__access_img_map_center_overflow_jpg__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ModalUpdateData__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__AddressLabel__ = __webpack_require__(12);
...
function UploadImage() {
  var _useState = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["useState"])(-1),
      _useState2 = _slicedToArray(_useState, 2),
      x = _useState2[0],
      setX = _useState2[1];
  ...
  var _useState9 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["useState"])({
    ...
    description: ""
      ...
      _useState10 = _slicedToArray(_useState9, 2),
      addressInfro = _useState10[0],
      setAddressInfo = _useState10[1];
  ...
  var _useState13 = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_0_react__["useState"])(JSON.parse(localStorage.getItem('lists'))),
      _useState14 = _slicedToArray(_useState13, 2),
      listData = _useState14[0],
      setListData = _useState14[1];

  var printCoordinates = function printCoordinates(e) {
  ...
  var handleChange = function handleChange(e) {
    ...
    setAddressInfo(Object.assign({}, addressInfro, _defineProperty({}, name, value)));
  };

  var addToListData = function addToListData() {
    var newElement = {
    ...
    setListData([].concat(_toConsumableArray(listData), [newElement]));
    localStorage.setItem('lists', JSON.stringify([].concat(_toConsumableArray(listData), [newElement])));
    setAddressInfo({
      title: "",
      description: ""
    });
  ...
  var getEditItem = function getEditItem(item) {
    setIsShowModal(true);
    setIsEdit(true);
    setX(item.x);
    setY(item.y);
  ...
  var handleEdit = function handleEdit() {
    var newList = listData.map(function (item) {
      return currentItem.id === item.id ? Object.assign({}, item, {
        title: addressInfro.title,
        description: addressInfro.description
      }) : item;
    });
  ...
  var deleteItem = function deleteItem(id) {
    var newArr = listData.filter(function (item) {
      return item.id !== id;
    });
    setListData(newArr);
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      ...
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        "div",
        { className: "image-bound" },
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img", { onClick: function onClick(e) {
            return printCoordinates(e);
          }, src: __WEBPACK_IMPORTED_MODULE_1__access_img_map_center_overflow_jpg___default.a, alt: "abc" }),
        listData && listData.length > 0 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.Fragment,
          null,
          listData.map(function (item) {
            return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__AddressLabel__["a" /* default */], {
              item: item,
      ...
      isShowModal && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__ModalUpdateData__["a" /* default */], {
        x: x,
        y: y,
...
*/
var aa=__webpack_require__(0),ca=__webpack_require__(27);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
/***/ })
/******/ ]);
//# sourceMappingURL=main.0b825da6.js.map